...
export const users = pgTable("users", {
  ...
  allergies: json("allergies").$type<Record<string, boolean>>(),
...
export type InsertConsumedItem = z.infer<typeof insertConsumedItemSchema>;
export type ConsumedItem = typeof consumedItems.$inferSelect;
